...
def build_report(r, config):
    ...
    report.append(["上周确诊最多国家确诊数", r['weekly_confirmed_data'][0]['value']])
    report.append(["上周确诊第二多国家", r['weekly_confirmed_data'][1]['name']])
    report.append(["上周确诊第二多国家确诊数", r['weekly_confirmed_data'][1]['value']])
    report.append(["上周死亡最多国家", r['weekly_death_data'][0]['name']])
    report.append(["上周死亡最多国家死亡数", r['weekly_death_data'][0]['value']])
    report.append(["上周死亡第二多国家", r['weekly_death_data'][1]['name']])
    report.append(["上周死亡第二多国家死亡数", r['weekly_death_data'][1]['value']])
    report.append(["上周确诊增速最快国家", r['weekly_confirmed_growth'][1]['name']])
    report.append(["上周确诊增速最快国家增速值", r['weekly_confirmed_growth'][1]['growth']])
    report.append(["上周确诊增速第二快国家", r['weekly_confirmed_growth'][2]['name']])
    report.append(["上周确诊增速第二快国家增速值", r['weekly_confirmed_growth'][2]['growth']])
    report.append(["上周死亡增速最快国家", r['weekly_death_growth'][1]['name']])
    report.append(["上周死亡增速最快国家增速值", r['weekly_death_growth'][1]['growth']])
    report.append(["上周死亡增速第二快国家", r['weekly_death_growth'][2]['name']])
    report.append(["上周死亡增速第二快国家增速值", r['weekly_death_growth'][2]['growth']])
